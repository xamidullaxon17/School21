...
int main() {
  ...
  Suite *s21_math_tests[] = {
      ...
      test_s21_ceil(),  test_s21_cos(),  test_s21_sin(),  test_s21_fabs(),
      test_s21_floor(), test_s21_fmod(), test_s21_sqrt(), test_s21_tan(),
      test_s21_log(),   test_s21_pow(),  test_s21_exp(),  NULL};
