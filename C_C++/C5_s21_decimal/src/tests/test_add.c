...
START_TEST(s21_add_10) {
  s21_decimal value_1 = {{0x00000000, 0x00000000, 0xFFFFFFFF, 0}};
  s21_decimal value_2 = {{0x00000000, 0x00000000, 0xFFFFFFFF, 0}};
  s21_decimal result = {0};
  s21_decimal res = {{0x00000000, 0x00000001, 0xFFFFFFFE, 0}};
  int res2 = s21_from_decimal_to_int(res, &res2);
  int return_value = s21_add(value_1, value_2, &result);
  ck_assert_int_eq(return_value, res2);
}
END_TEST
