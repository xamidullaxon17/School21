...
### Общая информация <div id="11"></div>
...
3. Корнипаев, И. Требования для программного обеспечения: рекомендации по сбору и документации. — Москва : УчКнига_КПТ, 2017.
2. Халл, Э., Джексон, К., Дик, Дж. Инженерия требований / Э. Халл, К. Джексон, Дж. Дик. — Москва : ДМК Пресс, 2019
...
2. Анализ требований по Вигерсу (2004). Этапы сбора требований // Бизнес-Анализ в России. — URL: https://business-analytics-russia.ru/requirements-analysis/analysis-of-requirements-wiegers-2004/#Уровни_требованийКарл Вигерс, Джой Битти «Разработка требований к программному обеспечению», издание третье, глава 1 и другие.

## Chapter II <div id="chapter-ii"></div>

### Инструкция <div id="21"></div>
...
![img1.png](misc/images/Рисунок_1._Взаимосвязи_и_уровни_требований.jpg)
...
*Рисунок 2.*
![img1.png](misc/images/Рисунок_2__.jpg)
...
### Exercise 00 — Роли и их действия as is <div id="51"></div>
**Для каждой задачи:** 
...
### Exercise 01 — Создание контекстной диаграммы <div id="52"></div>
**Для задачи 2:**
...
![img1.png](misc/images/Рисунок_2.jpg)

### Exercise 02 — Разрешение проблем стейкхолдеров <div id="53"></div>
**Для каждой задачи:**
...
### Exercise 03 — Проверка входных/выходных потоков данных <div id="54"></div>
**Для каждой задачи:**
...
### Exercise 04 — Дополнение артефактов <div id="55"></div>
**Для каждой задачи:**
